function showFile(input) {
  ...
  function buscarCEP() {
    ...
    fetch(url)
      ...
      .then(adress => {
        document.getElementById("state").value = adress.state || "";
        document.getElementById("city").value = adress.city || "";
        document.getElementById("neighborhood").value = adress.neighborhood || "";
        document.getElementById("street").value = adress.street || "";
      })
      .catch(error => {
